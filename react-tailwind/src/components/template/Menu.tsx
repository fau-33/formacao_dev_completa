...
export default function Menu(props: MenuProps) {
  return (
    ...
    >
      ...
      <MenuItem
        icone={<IconTextPlus />}
        texto="Tudo é classes"
        url="/conceitos/classes"
      />
      <MenuItem
        icone={<IconClick />}
        texto="Pseudo Classes"
        url="/conceitos/pseudo"
      />
      <MenuItem
        icone={<IconDeviceMobile />}
        texto="Mobile-First"
        url="/conceitos/mobile"
      />
      <MenuItem
        icone={<IconComponents />}
        texto="Componentes"
        url="/conceitos/componentes"
      />

      <MenuGrupo texto="Box Model" />
      <MenuItem
        icone={<IconBoxPadding />}
        texto="Padding"
        url="/caixa/padding"
      />
